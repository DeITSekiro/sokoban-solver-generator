...
def sidebar_widgets(window):
    ...
    visualizer = Label(window, f'Visualize', 850, 40, 16)
    toggle = Toggle(window, 970, 45, 18, 22, handleRadius=11)
    bfs_button = Button(
        ...
        # modify
    dfs_button = Button(
        window, 1055, 450, 130, 40, text='DFS', radius=5,
        font=pygame.font.SysFont('Verdana', 18, bold=True),
    ...
    window, 1055, 545, 130, 40, text='Hill-Climbing', radius=5,
    font=pygame.font.SysFont('Verdana', 14, bold=True),
